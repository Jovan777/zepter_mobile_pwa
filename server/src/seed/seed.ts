...
const products = [
  {
    ...
    images: [image('myionz-pro.jpg'), image('myionz-pro-2.jpg')],
  ...
  },
  {
    ...
    images: [image('aqueena-pro-1.jpg'), image('aqueena-pro-2.png')],
    badges: ['Najprodavanije'],
  ...
  },
  {
    ...
    categoryName: 'Posuđe',
    images: [image('grande-set-posudja-1.jpg'), image('universal-set-posudja.jpg')],
    badges: ['Najprodavanije'],
  ...
  },
  {
    ...
    images: [image('bioptron-medall-1.jpg'), image('bioptron-medall-2.png')],
    badges: ['Najprodavanije'],
  ...
  },
  {
    ...
    categorySlug: 'posudje',
    categoryName: 'Posuđe',
    images: [image('frellux-1.jpeg'), image('frellux-2.jpeg'), image('frellux-3.jpg')],
    badges: ['Novo'],
  ...
  },
  {
    ...
    images: [image('zero-g-black-titanium-outdoor-1.jpg')],
    badges: ['Novo'],
